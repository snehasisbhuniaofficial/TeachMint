...
class ViewStudents extends StatefulWidget {
  String batchname;
  User user;
  ViewStudents(this.batchname, this.user, {super.key});

  @override
  State<ViewStudents> createState() => _ViewStudentsState(batchname, user);
}

class _ViewStudentsState extends State<ViewStudents> {
  String batchname;
  User user;
  _ViewStudentsState(this.batchname, this.user);
  ...
  Future<void> _fetchStudents(String batchname) async {
    _students.clear();
    _students = await db.getBatchStudents(batchname, int.parse(user.id));
    setState(() {
                            ...
                            if (_form.currentState!.validate()) {
                              if (_name.text.isNotEmpty &&
                                ...
                                addStudent(
                                    ...
                                    batchname.toUpperCase().toString(),
